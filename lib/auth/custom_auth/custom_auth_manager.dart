...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    patientUiAuthUserSubject.add(
      PatientUiAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<PatientUiAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  PatientUiAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = PatientUiAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    patientUiAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
