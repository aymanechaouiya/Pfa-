...
class _DossierMedicalWidgetState extends State<DossierMedicalWidget> {
  late DossierMedicalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DossierMedicalModel());
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Expanded(
                                                  child: Text(
                                                    'diabete,maladie chroniqeu, hypertension',
                                                    textAlign: TextAlign.center,
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Flexible(
                                                child: Text(
                                                  'maladie gastrique avec un uclcere gastro_duodenale',
                                                  textAlign: TextAlign.center,
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
