...
class CreerOrdonnanceWidget extends StatefulWidget {
  const CreerOrdonnanceWidget({super.key});

  @override
  State<CreerOrdonnanceWidget> createState() => _CreerOrdonnanceWidgetState();
}

class _CreerOrdonnanceWidgetState extends State<CreerOrdonnanceWidget> {
  late CreerOrdonnanceModel _model;
