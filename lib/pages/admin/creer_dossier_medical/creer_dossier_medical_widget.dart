...
import 'creer_dossier_medical_model.dart';
export 'creer_dossier_medical_model.dart';

class CreerDossierMedicalWidget extends StatefulWidget {
  const CreerDossierMedicalWidget({super.key});

  @override
  State<CreerDossierMedicalWidget> createState() =>
      _CreerDossierMedicalWidgetState();
}

class _CreerDossierMedicalWidgetState extends State<CreerDossierMedicalWidget> {
  late CreerDossierMedicalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreerDossierMedicalModel());
