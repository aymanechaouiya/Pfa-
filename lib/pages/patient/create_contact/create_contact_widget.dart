  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UsersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRow> createContactUsersRowList = snapshot.data!;
        final createContactUsersRow = createContactUsersRowList.isNotEmpty
            ? createContactUsersRowList.first
            : null;
                  ...
                  FutureBuilder<List<ChatRow>>(
                    future: ChatTable().queryRows(
                      queryFn: (q) => q.contains(
                        'users',
                        '{${createContactUsersRow?.username}}',
                      ),
                    ),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
