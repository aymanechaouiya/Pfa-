...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => const ProfilePatientWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => const ProfilePatientWidget(),
        ),
        FFRoute(
          name: 'HomePage',
          path: '/homePage',
        ...
        FFRoute(
          ...
          path: '/appointemenList',
          builder: (context, params) => const AppointemenListWidget(),
        ),
        FFRoute(
          name: 'ListOrdonance',
          path: '/listOrdonance',
          builder: (context, params) => const ListOrdonanceWidget(),
        ),
        FFRoute(
          name: 'dashboardAdmin',
          path: '/dashboardAdmin',
